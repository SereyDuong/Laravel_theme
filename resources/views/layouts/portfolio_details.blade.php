        ...
        <div class="portfolio-details-slider swiper init-swiper">
          ...
          <div class="swiper-wrapper align-items-center">
            ...
            <div class="swiper-slide">
              <img src="{{asset('theme/assets/img/portfolio/app-1.jpg')}}" alt="">
            </div>

            <div class="swiper-slide">
              <img src="{{asset('theme/assets/img/portfolio/product-1.jpg')}}" alt="">
            </div>

            <div class="swiper-slide">
              <img src="{{asset('theme/assets/img/portfolio/branding-1.jpg')}}" alt="">
            </div>

            <div class="swiper-slide">
              <img src="{{asset('theme/assets/img/portfolio/books-1.jpg')}}" alt="">
            </div>
