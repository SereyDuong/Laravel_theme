          ...
          <section id="blog-details" class="blog-details section">
            <div class="container">
              ...
              <article class="article">
                ...
                <div class="post-img">
                  <img src="{{asset('theme/assets/img/blog/blog-1.jpg')}}" alt="" class="img-fluid">
                </div>
                ...
                <div class="content">
                  ...
                  <img src="{{asset('theme/assets/img/blog/blog-inside-post.jpg')}}" class="img-fluid" alt="">
          ...
          <section id="blog-comments" class="blog-comments section">
            ...
            <div class="container">
              ...
              <div id="comment-1" class="comment">
                <div class="d-flex">
                  <div class="comment-img"><img src="{{asset('theme/assets/img/blog/comments-1.jpg')}}" alt=""></div>
                  <div>
              ...
              <div id="comment-2" class="comment">
                <div class="d-flex">
                  <div class="comment-img"><img src="{{asset('theme/assets/img/blog/comments-2.jpg')}}" alt=""></div>
                  <div>
                ...
                <div id="comment-reply-1" class="comment comment-reply">
                  <div class="d-flex">
                    <div class="comment-img"><img src="{{asset('theme/assets/img/blog/comments-3.jpg')}}" alt=""></div>
                    <div>
                  ...
                  <div id="comment-reply-2" class="comment comment-reply">
                    <div class="d-flex">
                      <div class="comment-img"><img src="{{asset('theme/assets/img/blog/comments-4.jpg')}}" alt=""></div>
                      <div>
              ...
              <div id="comment-3" class="comment">
                <div class="d-flex">
                  <div class="comment-img"><img src="{{asset('theme/assets/img/blog/comments-5.jpg')}}" alt=""></div>
                  <div>
              ...
              <div id="comment-4" class="comment">
                <div class="d-flex">
                  <div class="comment-img"><img src="{{asset('theme/assets/img/blog/comments-6.jpg')}}" alt=""></div>
                  <div>
          ...
          <div class="widgets-container">
            ...
            <div class="blog-author-widget widget-item">
              ...
              <div class="d-flex flex-column align-items-center">
                <img src="{{asset('theme/assets/img/blog/blog-author.jpg')}}" class="rounded-circle flex-shrink-0" alt="">
                <h4>Jane Smith</h4>
