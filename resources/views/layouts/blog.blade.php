        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            <article class="position-relative h-100">
              ...
              <div class="post-img position-relative overflow-hidden">
                <img src="{{asset('theme/assets/img/blog/blog-1.jpg')}}" class="img-fluid" alt="">
          ...
          <div class="col-lg-4">
            <article class="position-relative h-100">
              ...
              <div class="post-img position-relative overflow-hidden">
                <img src="{{asset('theme/assets/img/blog/blog-2.jpg')}}" class="img-fluid" alt="">
          ...
          <div class="col-lg-4">
            <article class="position-relative h-100">
              ...
              <div class="post-img position-relative overflow-hidden">
                <img src="{{asset('theme/assets/img/blog/blog-3.jpg')}}" class="img-fluid" alt="">
          ...
          <div class="col-lg-4">
            <article class="position-relative h-100">
              ...
              <div class="post-img position-relative overflow-hidden">
                <img src="{{asset('theme/assets/img/blog/blog-4.jpg')}}" class="img-fluid" alt="">
          ...
          <div class="col-lg-4">
            <article class="position-relative h-100">
              ...
              <div class="post-img position-relative overflow-hidden">
                <img src="{{asset('theme/assets/img/blog/blog-5.jpg')}}" class="img-fluid" alt="">
          ...
          <div class="col-lg-4">
            <article class="position-relative h-100">
              ...
              <div class="post-img position-relative overflow-hidden">
                <img src="{{asset('theme/assets/img/blog/blog-6.jpg')}}" class="img-fluid" alt="">
